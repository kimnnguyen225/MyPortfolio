...
<html>
  ...
  <body>
    ...
    <table style="font-size: 1.2rem; color: black border-collapse:separate; border-spacing:0 7px;">
      ...
      <tr><td><i class="far fa-hand-point-right"></i> In order to be a successful, well rounded Software Developer, I continue to grow my knowledge and <br> experience daily by learning significant skills from online resources.</td></tr>
      <tr><td><i class="far fa-hand-point-right"></i> Problem resolution, attentive, strong analytical, prioritizing, work under pressure, interpersonal, <br> and project management.</td></tr>
      <tr><td><i class="far fa-hand-point-right"></i> Currently, I am seeking for a <strong>Junior Software Developer</strong> position in Cincinnati, OH and its <br>surrounding areas like Mason, Hamilton, BlueAsh, and West Chester.</td></tr>
      <tr><td><b class="word-color">Some of my favorite resources to geek:</b></td></tr>
      <tr><td><i class="far fa-hand-point-right"></i> Youtube: <a href="#" onclick="window.open('https://www.youtube.com/channel/UC29ju8bIPH5as8OGnQzwJyA')">Traversy Media</a>, <a href="#" onclick="window.open('https://www.youtube.com/channel/UCJbPGzawDH1njbqV-D5HqKw')">The New Boston</a>, and more.</td></tr>
